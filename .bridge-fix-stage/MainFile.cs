...
public partial class MainFile : Node
{
    ...
    public static Task OnGameThreadAsync(Func<Task> action)
    {
    ...
    private static async Task LaunchRlAutoSlayAsync()
    {
        ...
        Logger.Log("[RlAutoSlay] Ready; waiting for agent resume_automation handshake");
    }
}
...
public static class WaitSpeedPatch
{
    ...
    {
        if (RlAutoSlayer.FastModeEnabled)
        {
